...
<asm version="1.0" name="0">
	<cp>
		...
		<constant value="view"/>
		<constant value="OpenView_MultipleChoiceView"/>
		...
		<constant value="34:5-36:6"/>
		<constant value="__applyMultipleChoice"/>
		<constant value="35:19-35:22"/>
	...
	<operation name="112">
		...
		<linenumbertable>
			...
			<lne id="111" begin="14" end="21"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="3" name="78" begin="7" end="21"/>
			<lve slot="4" name="82" begin="11" end="21"/>
